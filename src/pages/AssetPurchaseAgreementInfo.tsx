...
const AssetPurchaseAgreementInfo: React.FC = () => {
  ...
  // DEBUG: Add console log to verify this component is loaded
  React.useEffect(() => {
    console.log("✅ AssetPurchaseAgreementInfo component loaded - CUSTOM CONTENT VERSION");
  }, []);
  ...
  return (
    <div style={{ maxWidth: '1024px', margin: '0 auto', padding: '48px 16px', backgroundColor: '#ffffff' }}>
      ...
      <div style={{ display: 'flex', gap: '16px' }}>
        <button 
          onClick={() => navigate("/asset-purchase-agreement-form")}
          style={{
